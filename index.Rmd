...
Será que municípios que possuem idades médias mais avançadas possuem uma população mais idosa? Assim, elaborei um gráfico simples de dispersão para verificar como é essa distribuição. 
```{r}
library(ggplot2)
...
ggplot2::ggplot(dados, 
  ...
  geom_boxplot()
```
>>>>>>> 06b5083b9859fbdacc13600cf2f5ca2c4042ed8d
